...
namespace Mapchat
{
    //Customization ID has been ommitted to protect data
    public class ExampleStreaming : MonoBehaviour
    {
        ...
        string outputText;
        private string _acousticCustId = ""; //Has been ommitted
        ...
        public bool Active
        {
            ...
            set
            {
                if (value && !_service.IsListening)
                {
                    ...
                    _service.AcousticCustomizationId = (string.IsNullOrEmpty(_acousticCustId) ? null : _acousticCustId);
